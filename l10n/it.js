OC.L10N.register(
    ...
    "Delete" : "Elimina",
    "Text templates are snippets of text that users can quickly insert when they're using Text, Collectives, Talk, Mail or any place where the smart picker is available. Here you can create templates that will be available to all users on this instance." : "Text Templates sono frammenti di testo che gli utenti possono inserire rapidamente quando utilizzano SMS, Collettivi, Talk, Mail o qualsiasi altro strumento in cui sia disponibile il selettore intelligente. Qui puoi creare modelli che saranno disponibili a tutti gli utenti di questa istanza.",
    "Text templates are snippets of text that you can quickly insert when you're using Text, Collectives, Talk, Mail or any place where the smart picker is available." : "Text Templates sono frammenti di testo che puoi inserire rapidamente quando utilizzi Text, Collectives, Talk, Mail o qualsiasi altro strumento in cui è disponibile lo smart picker.",
    ...
    "Admins can create and manage text templates for everyone." : "Gli amministratori possono creare e gestire modelli di testo per tutti.",
    "Edit admin templates" : "Modifica modelli di amministrazione",
