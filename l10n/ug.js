OC.L10N.register(
    ...
    "Add a new text template" : "يېڭى تېكىست قېلىپى قوش",
    "Create" : "قۇر",
    "Cancel" : "بىكار قىلىش",
    "Save" : "ساقلا",
    ...
    "Delete" : "ئۆچۈر",
    "Text templates are snippets of text that users can quickly insert when they're using Text, Collectives, Talk, Mail or any place where the smart picker is available. Here you can create templates that will be available to all users on this instance." : "تېكىست قېلىپلىرى ئىشلەتكۈچىلەر تېكىست، كوللىكتىپلار، سۆھبەت، پوچتا ياكى ئەقلىي تاللىغۇچ بار باشقا جايلارنى ئىشلەتكەندە تېزلا كىرگۈزەلەيدىغان تېكىست پارچىلىرى. بۇ يەردە سىز بۇ مىسالدىكى بارلىق ئىشلەتكۈچىلەرگە تەمىنلىنىدىغان قېلىپلارنى يارىتالايسىز.",
    "Text templates are snippets of text that you can quickly insert when you're using Text, Collectives, Talk, Mail or any place where the smart picker is available." : "تېكىست قېلىپلىرى تېكىست، كوللىكتىپلار، سۆھبەت، پوچتا ياكى ئەقلىي تاللىغۇچ بار باشقا جايلارنى ئىشلەتكەندە تېزلا كىرگۈزگىلى بولىدىغان تېكىست پارچىلىرى.",
    ...
    "Admins can create and manage text templates for everyone." : "باشقۇرغۇچى تىكىست قېلىپىنى ھەممەيلەن ئۈچۈن قۇرالايدۇ ھەمدە باشقۇرالايدۇ.",
    "Edit admin templates" : "باشقۇرغۇچى قېلىپىنى تەھرىرلە",
