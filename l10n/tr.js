OC.L10N.register(
    ...
    "Delete" : "Sil",
    "Text templates are snippets of text that users can quickly insert when they're using Text, Collectives, Talk, Mail or any place where the smart picker is available. Here you can create templates that will be available to all users on this instance." : "Yazı kalıpları, kullanıcıların Yazı, Topluluklar, Konuş, E-posta veya akıllı seçicinin kullanılabildiği her yerde hızlıca ekleyebileceği yazı parçalarıdır. Burada, bu kopyadaki tüm kullanıcıların kullanabileceği kalıplar oluşturabilirsiniz.",
